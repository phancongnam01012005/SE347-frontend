...
function Menubar({ className, ...props }) {
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn(
        "bg-white flex h-9 items-center gap-1 rounded-md border p-1 shadow-sm",
        className
      )}
      {...props}
    />
...
function MenubarTrigger({ className, ...props }) {
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "focus:bg-gray-100 focus:text-gray-900 data-[state=open]:bg-gray-100 data-[state=open]:text-gray-900 flex items-center rounded-sm px-2 py-1 text-sm font-medium outline-none select-none",
        className
      )}
      {...props}
    />
